...
public class MyFCMService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        HashMap<String, ObjectOutputStream> iotmaps = maps;
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            notificationManager.createNotificationChannel(mChannel);//implementation 'androidx.appcompat:appcompat:1.1.0'
            //1.1.0으로 해야지 createNotificationChannel 이 가능하다.
        }
